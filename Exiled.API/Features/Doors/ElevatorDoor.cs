...
namespace Exiled.API.Features.Doors
{
    ...
    public class ElevatorDoor : BasicDoor
    {
        ...
        /// </summary>
        public ElevatorGroup Group => Base.Chamber.NetworkAssignedGroup;
        ...
        /// </summary>
        public ElevatorPanel Panel => Object.FindObjectsOfType<ElevatorPanel>().FirstOrDefault(r => r._door == Base);
